...
import { PurchaseInvoice, InvoiceItem } from '@/types'
...
export default function PurchaseInvoiceForm({ invoice, onSubmit, onCancel }: PurchaseInvoiceFormProps) {
        ...
        <div className="border-t pt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                type="text"
                {...register('supplier_name', { required: '공급업체명은 필수입니다' })}
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                placeholder="(주)공급업체"
              />
            ...
            <div>
              ...
              <input
                type="text"
                {...register('supplier_business_number', { required: '사업자등록번호는 필수입니다' })}
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
